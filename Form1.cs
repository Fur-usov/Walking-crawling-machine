...
namespace Project_Kulisa_Visual
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            //g.TranslateTransform(f.Height/2, f.Width/2 );
            
            g.DrawRectangle(new Pen(Color.Blue), 100, 100, 200, 200);
            for (double i = 0.0; i <= 2 * PI; i += period * rad)
            {
                g.DrawLine(new Pen(Color.Black), (int)Position_X(R, L, E, i) , (int )Position_Y(R, L, E, i), (int)Position_X(R, L, E, i), (int)Position_Y(R, L, E, i));
            }
        }
    }
}
